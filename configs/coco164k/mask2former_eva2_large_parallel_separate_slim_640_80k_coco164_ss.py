...
_base_ = [
    '../_base_/models/mask2former_eva2_cocostuff.py',
    '../_base_/datasets/coco-stuff164k_512x512_repeat_ms.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        pretrained=None),
    decode_head=dict(
        type='Mask2Former_lite_parallel_separate_slim_Head',
        in_channels=1024,
        feat_channels=256,
        out_channels=256,
        num_queries=200,
...
optimizer = dict(
    ...
    paramwise_cfg=dict(num_layers=24, decay_rate=0.9, decay_type='layer_wise_vit', custom_keys={'head': dict(lr_mult=10.)}))
#optim_wrapper = dict(
#    type='OptimWrapper',
#    optimizer=optimizer,
